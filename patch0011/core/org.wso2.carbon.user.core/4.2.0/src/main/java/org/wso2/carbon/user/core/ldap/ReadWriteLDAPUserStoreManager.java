...
public class ReadWriteLDAPUserStoreManager extends ReadOnlyLDAPUserStoreManager {
    ...
    public void doUpdateCredential(String userName, Object newCredential, Object oldCredential)
        ...
        try {
            ...
            String message = "Can not access the directory service for user : " + userName;
            if (log.isDebugEnabled()) {
                log.debug(message, e);
            }
...
//                    claimEntry.setValue(escapeISSpecialCharacters(uidName));
            ...
            String errorMessage =
                    "Profile information could not be updated in ApacheDS LDAP user store for user : " + userName;
            if (log.isDebugEnabled()) {
                log.debug(errorMessage, e);
            }
            throw new UserStoreException(errorMessage, e);
    ...
    private NamingEnumeration<SearchResult> searchInUserBase(String userName, String searchFilter,
        ...
        try {
            ...
            String errorMessage = "Error occurred while searching in user base according to filter : " + searchFilter;
            if (log.isDebugEnabled()) {
                log.debug(errorMessage, e);
            }
            throw new UserStoreException(errorMessage, e);
    ...
    protected NamingEnumeration<SearchResult> searchInGroupBase(String searchFilter,
        ...
        try {
            ...
            String errorMessage =
                    "Error occurred while searching in group base : " + searchBase + " & search filter : " +
                    searchFilter;
            if (log.isDebugEnabled()) {
                log.debug(errorMessage, e);
            }
