    ...
    private void doSOAP(MessageContext mainInMsgContext,
        ...
        try {
            ...
            if (tenantInMsgCtx.getOperationContext() != null) {
                respWritten = (String) tenantInMsgCtx.getOperationContext().getProperty(
...
//				mainInMsgContext.setOperationContext(null);
 	...
 	if (service.equals("")) {
        ...
        try {
            ...
            if (httpMethod.equals(Constants.Configuration.HTTP_METHOD_GET) ||
                    ...
                    httpMethod.equals(Constants.Configuration.HTTP_METHOD_HEAD)) {
