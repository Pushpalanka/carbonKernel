...
//        primaryHazelcastConfig.getSecurityConfig().addMemberLoginModuleConfig(new UsernamePasswordCredentials());
        ...
        if (licenseKey != null) {
            // Setting default InMemoryFormat, previously this was OFFHEAP but its deprecated in 3.4.2
        ...
        // Start thread which will try to obtain Hazelcast lock. If lock is acquired by this member,
