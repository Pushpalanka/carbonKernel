...
public class JDBCUserStoreConstants {
    ...
    static final String CASE_INSENSITIVE_USERNAME = "CaseInsensitiveUsername";
    static final String CASE_INSENSITIVE_USERNAME_DESCRIPTION = "Whether the username is case insensitive or not";
...
//        setMandatoryProperty(UserStoreConfigConstants.dataSource, "jdbc/WSO2CarbonDB", UserStoreConfigConstants.dataSourceDescription);
        ...
        setProperty(UserStoreConfigConstants.DisplayNameAttribute, "Display name attribute", "", UserStoreConfigConstants.DisplayNameAttributeDescription);
        setProperty(UserStoreConfigConstants.CaseInsensitiveUsername, "Is usename case insensitive", "false", UserStoreConfigConstants.CaseInsensitiveUsernameDescription);
...
//        setProperty("RolenameJavaRegEx","^[^~!#$;%^*+={}\\\\|\\\\\\\\&lt;&gt;,\\\'\\\"]{3,30}$","A regular expression to validate role names");
        ...
        setProperty(CASE_INSENSITIVE_USERNAME, "Case Insensitive Username", "false", CASE_INSENSITIVE_USERNAME_DESCRIPTION);
    }
