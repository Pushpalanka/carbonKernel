...
//		}
        ...
        try {
            ...
            String errorMessage = "Cannot create connection to LDAP server.";
            if (log.isDebugEnabled()) {
    ...
    public String[] doListUsers(String filter, int maxItemLimit) throws UserStoreException {
        ...
        if (displayNameAttribute != null && !("".equals(displayNameAttribute.trim()))) {
            returnedAtts =
...
//                            name = decodeEscapedCharacters(name); //revert encoding for IS special character
                            String display = null;
                            if (displayName != null) {
...
//			}
    ...
    protected String getNameInSpaceForUserName(String userName, String searchBase, String searchFilter) throws UserStoreException {
        ...
        try {
            ...
            //should not throw this exception out
            if (log.isDebugEnabled()) {
                        ...
                        if (sr.getAttributes() != null) {
                            ...
                            if (attr != null) {
                                for (Enumeration vals = attr.getAll(); vals.hasMoreElements(); ) {
                                    ...
                                    //name = decodeEscapedCharacters(name);
                                    if (debug) {
