...
public class ActiveDirectoryUserStoreConstants {
    ...
    static {
        ...
        setProperty(ReadOnlyLDAPUserStoreConstants.CASE_INSENSITIVE_USERNAME, "Case Insensitive Username", "false",
                ReadOnlyLDAPUserStoreConstants.CASE_INSENSITIVE_USERNAME_DESCRIPTION);
